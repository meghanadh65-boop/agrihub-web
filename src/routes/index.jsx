...
import { ArrowRight, ShieldCheck, Truck, Sparkles, Leaf, Star } from "lucide-react";
...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "FLTY Services - Agri Shop & Services for Farmers" },
      {
        name: "description",
        content:
          "Shop seeds, fertilizers, and crop protection. Book drones, harvesters, tractors, and workforce on demand.",
      },
      { property: "og:title", content: "FLTY Services - Agri Shop & Services for Farmers" },
      {
        property: "og:description",
        content: "Farmer-first e-commerce with drone, harvester, tractor and workforce booking.",
      },
    ],
  }),
  component: HomePage,
        ...
        <div className="relative mx-auto flex min-h-[560px] max-w-7xl flex-col justify-center px-4 py-20 sm:px-6">
          ...
          <div className="mt-8">
            <Link to="/shop">
              <Button
                size="lg"
                className="rounded-full bg-primary px-8 text-primary-foreground hover:bg-brand-green-dark"
              >
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <Link to="/services">
              <Button
                size="lg"
                variant="secondary"
                className="bg-brand-yellow text-foreground hover:brightness-95"
              >
            ...
            {services.map((s) => (
              ...
              >
                <div className="relative h-40 overflow-hidden">
                  ...
                  <div className="absolute bottom-3 left-4 text-lg font-bold text-background">
                    {s.name}
                  </div>
                </div>
                <div className="p-5">
          ...
          <div className="relative flex flex-col items-start gap-4 md:flex-row md:items-center md:justify-between">
            <div className="text-primary-foreground">
              ...
              <h3 className="mt-2 text-3xl font-extrabold md:text-4xl">
                Kharif Season Sale — up to 25% off
              </h3>
              <p className="mt-2 max-w-lg opacity-90">
                Save big on seeds, fertilizers and crop protection this season. Limited stock.
              </p>
            </div>
            <Link to="/shop">
          ...
          {[
            {
              ...
              body: "Genuine products sourced directly from manufacturers.",
            },
            {
              icon: Truck,
              title: "Village delivery",
              body: "Doorstep delivery to 6,000+ villages across India.",
            },
            {
              icon: Sparkles,
              title: "Expert support",
              body: "Free agronomist advice in your local language.",
            },
          ].map((f) => (
