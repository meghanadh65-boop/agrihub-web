          ...
          <Card className="mt-4 flex items-center gap-3 border-primary/40 bg-brand-green/10 p-4">
            ...
            <div>
              ...
              <div className="text-sm text-muted-foreground">
                You'll receive updates on WhatsApp and here.
              </div>
            </div>
          </Card>
        )}
          ...
          {nextStep && (
            <div className="mt-4 border-t border-dashed border-border pt-4">
              ...
              <p className="mt-2 text-xs text-muted-foreground">
                Demo: in production, sellers push these updates.
              </p>
            </div>
          )}
        </Card>
          ...
          <Card className="p-6">
            ...
            <div className="mt-4 space-y-2 text-sm">
              ...
              <div className="flex items-start gap-2 text-muted-foreground">
                ...
                <span>
                  {order.address_line}, {order.village}
              ...
              {order.notes && (
                <div className="mt-2 rounded-md bg-accent/50 p-3 text-xs">{order.notes}</div>
              )}
            </div>
          </Card>
        </div>
