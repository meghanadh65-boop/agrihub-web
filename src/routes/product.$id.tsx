...
export const Route = createFileRoute("/product/$id")({
  ...
  errorComponent: () => <SiteShell><div className="p-10 text-center">Error loading product.</div></SiteShell>,
});
          ...
          <div>
            ...
            <div className="mt-6 flex items-baseline gap-3">
              ...
              {off > 0 && <>
                ...
                <span className="rounded-full bg-brand-green/15 px-2.5 py-0.5 text-sm font-bold text-primary">Save {off}%</span>
              </>}
            </div>
            <div className="mt-1 text-sm text-muted-foreground">{product.unit} · inclusive of taxes</div>
            ...
            <div className="mt-6 grid gap-3 sm:grid-cols-3">
              {[
                ...
                <div key={f.text} className="flex items-center gap-2 rounded-xl bg-accent/50 p-3 text-xs">
