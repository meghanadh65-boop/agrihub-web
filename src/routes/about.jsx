  ...
  head: () => ({
    meta: [
      { title: "About FLTY — Empowering Indian Farmers" },
      {
        name: "description",
        content:
          "FLTY is a farmer-first agri commerce and services platform bringing quality inputs and machinery to every village.",
      },
    ...
    <SiteShell>
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-24 sm:px-6">
          <span className="rounded-full bg-brand-yellow px-4 py-1.5 text-xs font-semibold text-foreground">
            About FLTY
          </span>
          ...
          <p className="mt-4 max-w-2xl text-lg text-background/85">
            FLTY brings together an agri e-commerce marketplace and on-demand machinery services in
            a single, farmer-friendly platform.
          </p>
        </div>
      </section>
        ...
        <div className="grid gap-10 md:grid-cols-2">
          <Card className="p-8">
            ...
            <p className="mt-2 text-muted-foreground">
              Put the tools of modern agriculture — genuine inputs, drone spraying, harvesters and
              skilled workforce — within reach of every farmer, in every language.
            </p>
          </Card>
          <Card className="p-8">
            ...
            <p className="mt-2 text-muted-foreground">
              A profitable, sustainable rural economy where every farmer has fair access to
              technology, transparent prices, and dependable support.
            </p>
          </Card>
        </div>
      </section>
          ...
          {[
            {
              icon: Users,
              title: "Marketplace",
              body: "Seeds, nutrition, crop protection and tools from top brands.",
            },
            {
              icon: TrendingUp,
              title: "Agri Services",
              body: "Drone, harvester, tractor and workforce, booked on demand.",
            },
            {
              icon: Award,
              title: "Advisory",
              body: "Free multilingual agronomy help before, during and after purchase.",
            },
          ].map((f) => (
