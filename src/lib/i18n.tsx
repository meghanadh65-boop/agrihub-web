...
const translations: Record<Lang, Dict> = {
  en: {
    ...
    "hero.subtitle": "Quality seeds, crop protection, and on-demand agri services — drone, harvester, tractor and skilled workforce, delivered to your village.",
  ...
  hi: {
    ...
    "hero.subtitle": "गुणवत्ता बीज, फसल सुरक्षा और मांग पर कृषि सेवाएँ — ड्रोन, हार्वेस्टर, ट्रैक्टर और कुशल श्रमिक, आपके गाँव तक।",
  ...
  te: {
    ...
    "hero.subtitle": "నాణ్యమైన విత్తనాలు, పంట రక్షణ మరియు అవసరమైనప్పుడు వ్యవసాయ సేవలు — డ్రోన్, హార్వెస్టర్, ట్రాక్టర్ మరియు నైపుణ్య కూలీలు.",
  ...
  ta: {
    ...
    "nav.drone": "ட்ரோன்",
    "nav.harvester": "அறுவடை",
    "nav.tractor": "டிராக்டர்",
    "nav.workforce": "தொழிலாளர்",
    "nav.contact": "தொடர்பு",
    "nav.orders": "என் ஆர்டர்கள்",
    "nav.login": "உள்நுழை",
    "cta.book": "இப்போது பதிவு",
    "cta.shop": "வாங்கு",
    "cta.explore": "சேவைகள் பார்",
    "cta.viewAll": "அனைத்தையும் பார்",
    "hero.tag": "விவசாயிகளுக்கு வலிமை",
    "hero.title": "உங்கள் பண்ணைக்கு தேவையான அனைத்தும் ஒரே இடத்தில்",
    "hero.subtitle": "தரமான விதைகள், பயிர் பாதுகாப்பு, மற்றும் ட்ரோன், அறுவடை, டிராக்டர், தொழிலாளர் சேவைகள்.",
    "home.categories": "வகைப்படி வாங்கு",
    "home.services": "எங்கள் சேவைகள்",
    "home.featured": "சிறப்பு தயாரிப்புகள்",
    "home.why": "விவசாயிகள் ஏன் FLTY-ஐ தேர்வு செய்கிறார்கள்",
    "home.offers": "சலுகைகள்",
    "footer.tagline": "விவசாயம், இப்போது எளிது.",
    "footer.rights": "அனைத்து உரிமைகளும் பாதுகாக்கப்பட்டவை.",
    "common.search": "தயாரிப்புகள், விதைகள், உரங்கள் தேடு…",
    "common.name": "முழு பெயர்",
    "common.phone": "தொலைபேசி எண்",
    "common.email": "மின்னஞ்சல்",
    "common.location": "கிராமம் / இடம்",
    "common.date": "விருப்ப தேதி",
    "common.acres": "நிலம் (ஏக்கர்)",
    "common.notes": "குறிப்புகள்",
    "common.submit": "பதிவை சமர்ப்பி",
    "common.message": "உங்கள் செய்தி",
    "book.title": "சேவையை பதிவு செய்",
    "book.success": "பதிவு உறுதி!",
    "book.successSub": "எங்கள் குழு 2 மணிநேரத்தில் தொடர்பு கொள்ளும்.",
  },
};
...
export function I18nProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    const saved = typeof window !== "undefined" ? (localStorage.getItem("flty-lang") as Lang | null) : null;
...
export const languageOptions: { code: Lang; label: string }[] = [
